  // depois das mudanças com o prisma e postgresql os dados dos personagens não estão sendo
  //  acessado essa parte serve justamente paara colocar as informações de "Dados_Personagens"
  //  no banco de dados
...
async function main() {
  ...
  console.log('✅ Médica da Peste criada');
